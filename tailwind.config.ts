...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Synapse OS Design Tokens — values come from CSS variables defined
        // per-theme in globals.css (.dark / .light), so these utility
        // classes (bg-primary, text-on-surface, etc.) automatically follow
        // whichever theme is active without any component changes.
